...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '../data/fist_hand/', 'Root directory to raw pet dataset.')
flags.DEFINE_string('output_dir', '../data/fist_hand/tf_records/', 'Path to directory to output TFRecords.')
flags.DEFINE_string('label_map_path', '../data/fist_hand/label_map.pbtxt',
