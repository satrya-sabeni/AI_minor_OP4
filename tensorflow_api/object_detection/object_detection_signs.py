...
PATH_TO_LABELS = 'build_models/sign_test/label_map.pbtxt'
PATH_TO_TEST_IMAGES_DIR = 'school_dir/test_images'
...
MODEL_NAME = 'build_graphs/sign_test/output_inference_graph'
...
def detect_objects(image_path):
    ...
    print(slice_imgpath)
    plt.savefig('test/{}'.format(image.filename), dpi = 300) #org dpi 62
    plt.close(fig)
